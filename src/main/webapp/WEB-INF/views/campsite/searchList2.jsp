	...
	<div class="row">
			...
			<div class="card h-100 border-0 shadow">
				<div class="card-img-top overflow-hidden gradient-overlay">
					<img class="img-fluid"
						...
						alt="Modern, Well-Appointed Room" style = "height: 18rem;"/> <a class="tile-link"
						href="${path }/campsite/view?campsite_index=3339"></a>
					...
					<div class="w-100">
						<h6 class="card-title">
							<a class="text-decoration-none text-dark"
								href="${path }/campsite/view?campsite_index=3339">하늘구름길 캠핑장</a>
						</h6>
			...
			<div class="card h-100 border-0 shadow">
				<div class="card-img-top overflow-hidden gradient-overlay">
					<img class="img-fluid"
						...
						alt="Cute Quirky Garden apt, NYC adjacent" style = "height: 18rem;"/> <a
						class="tile-link" href="${path }/campsite/view?campsite_index=7207"></a>
				...
				<div class="card-body d-flex align-items-center">
					<div class="w-100">
						<h6 class="card-title">
							<a class="text-decoration-none text-dark"
								href="${path }/campsite/view?campsite_index=7207">제암산자연휴양림 야영장</a>
						</h6>
						<div class="d-flex card-subtitle mb-3">
							<p class="flex-grow-1 mb-0 text-muted text-sm">일반야영장</p>
							<p class="flex-shrink-1 mb-0 card-stars text-xs text-end">
			...
			<div class="card h-100 border-0 shadow">
				<div class="card-img-top overflow-hidden gradient-overlay">
					<img class="img-fluid"
						...
						alt="Modern Apt - Vibrant Neighborhood!" style = "height: 18rem;"/> <a class="tile-link"
						href="${path }/campsite/view?campsite_index=3178"></a>
				...
				<div class="card-body d-flex align-items-center">
					<div class="w-100">
						<h6 class="card-title">
							<a class="text-decoration-none text-dark"
								href="${path }/campsite/view?campsite_index=3178">파래소캠핑장</a>
						</h6>
						<div class="d-flex card-subtitle mb-3">
							<p class="flex-grow-1 mb-0 text-muted text-sm">일반야영장</p>
							<p class="flex-shrink-1 mb-0 card-stars text-xs text-end">
		...
		<div class="col-sm-6 mb-5 hover-animate"
			...
			<div class="card h-100 border-0 shadow">
				<div class="card-img-top overflow-hidden gradient-overlay">
					<img class="img-fluid"
						src="https://gocamping.or.kr/upload/camp/163/thumb/thumb_720_7216qhx7hGkr8JkhNCC5rxl1.jpg"
						alt="Sunny Private Studio-Apartment" style = "height: 18rem;"/> <a class="tile-link"
						href="${path }/campsite/view?campsite_index=163"></a>
				...
				<div class="card-body d-flex align-items-center">
					<div class="w-100">
						<h6 class="card-title">
							<a class="text-decoration-none text-dark"
								href="${path }/campsite/view?campsite_index=163">강촌관광농원</a>
						</h6>
						<div class="d-flex card-subtitle mb-3">
						...
						<p class="card-text text-muted">
							1박 <span class="h4 text-primary">271000</span> 원
							<!-- 127.6012627/37.8191162 -->
						</p>
					</div>
				</div>
			</div>
			...
			<div class="card h-100 border-0 shadow">
				<div class="card-img-top overflow-hidden gradient-overlay">
					<img class="img-fluid"
						...
						alt="Mid-Century Modern Garden Paradise" style = "height: 18rem;" /> <a class="tile-link"
						href="${path }/campsite/view?campsite_index=2315"></a>
				...
				<div class="card-body d-flex align-items-center">
					<div class="w-100">
						<h6 class="card-title">
							<a class="text-decoration-none text-dark"
								href="${path }/campsite/view?campsite_index=2315">오투캐빈</a>
						</h6>
						<div class="d-flex card-subtitle mb-3">
			...
			<div class="card h-100 border-0 shadow">
				<div class="card-img-top overflow-hidden gradient-overlay">
					<img class="img-fluid"
						...
						alt="Brooklyn Life, Easy to Manhattan" style = "height: 18rem;"/> <a class="tile-link"
						href="${path }/campsite/view?campsite_index=7556"></a>
				...
				<div class="card-body d-flex align-items-center">
					<div class="w-100">
						<h6 class="card-title">
							<a class="text-decoration-none text-dark"
								href="${path }/campsite/view?campsite_index=7556">아르보리아파크 캠핑장</a>
						</h6>
						<div class="d-flex card-subtitle mb-3">
...
<script>
		...
		var positions = [
		    ...
		    {
		        title: '강촌관광농원',
		        latlng: new kakao.maps.LatLng(37.8191162, 127.6012627)
		    },
		    {
		        title: '오투캐빈',
		...
		var imageSrc = "https://cdn.icon-icons.com/icons2/317/PNG/512/map-marker-icon_34392.png"; 
