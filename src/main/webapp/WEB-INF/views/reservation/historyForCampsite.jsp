...
<section class="py-5">
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-end mb-5">
                <h1 class="hero-heading mb-0">내 캠핑장 예약 내역</h1>
                <!-- <a class="btn btn-link text-muted" href="apps-calendar.html">달력으로 확인하기</a>-->
            </div>
            <div class="d-flex justify-content-between align-items-center flex-column flex-lg-row mb-5">
                <div class="me-3">
                    <!-- strong 태그 안에 예약내역 개수 불러오기-->
                    <c:if test="${cnt != null}">
                    <p class="mb-3 mb-lg-0">내 캠핑장에 <strong>${cnt} </strong> 개의 예약이 있어요!</p>
                	</c:if>
                </div>
            ...
            <div class="list-group shadow mb-5">
				...
				<c:if test="${reserv != null}">
					<c:forEach var="reserv" items="${reserv}" varStatus="status">
                <a class="list-group-item list-group-item-action p-4" href="">
                    <div class="row">
                        <div class="col-lg-4 align-self-center mb-4 mb-lg-0">
                            <div class="d-flex align-items-center mb-3">
                                <h2 class="h5 mb-0">${names[status.index]}</h2>
                            </div>
                            <!--<p class="text-sm text-muted">Double Room</p>-->
                            <span class="badge badge-pill p-2 badge-secondary-light">${reserv.startdate} - ${reserv.enddate}</span>
                        </div>
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-6 col-md-4 col-lg-3 py-3 mb-3 mb-lg-0">
                                    ...
                                    <p class="text-sm fw-bold mb-0">${diffDays[status.index]} 박</p>
                                </div>
                                <div class="col-6 col-md-4 col-lg-3 py-3">
                                    <h6 class="label-heading">인원수</h6>
                                    <p class="text-sm fw-bold">${reserv.headCount} 명</p>
                                    <h6 class="label-heading">요금</h6>
                                    <p class="text-sm fw-bold mb-0">${reserv.totalCost2}원</p>
                                </div>
                                <div class="col-6 col-md-4 col-lg-3 py-3">
                                    <h6 class="label-heading">체크인 날짜</h6>
                                    <p class="text-sm fw-bold">${reserv.startdate} </p>
		...
		<ul class="pagination pagination-template d-flex justify-content-center ">
			...
			<li class="page-item"><a class="page-link" href="${ path }/reservation/historyForCampsite?page=${ pageInfo.prvePage }"> <i class="fa fa-angle-left "></i></a></li>
			...
			<c:if test="${ pageInfo.currentPage != status.current}">
				<li class="page-item "><a class="page-link " href="${ path }/reservation/historyForCampsite?page=${ status.current }"><c:out value="${ status.current }"/></a></li>
			...
			<li class="page-item "><a class="page-link " href="${ path }/reservation/historyForCampsite?page=${ pageInfo.nextPage }"> <i class="fa fa-angle-right "></i></a></li>
		</ul>
	</nav>
        </div>
    </section>
